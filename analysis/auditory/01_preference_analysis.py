...
for sess in all_sessions:
    ...
    # Vocalisation-specific PI + average duration
    ...
    voc_pi = np.nan
    if voc_visits_n > 0:
        avg_voc_dur = voc_time / voc_visits_n
        d = avg_voc_dur + avg_silent_dur
    ...
    # Other-sounds PI + average duration (non-vocalisation, non-silent stimuli)
