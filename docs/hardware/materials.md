...
Where the lab bought the parts. These are the suppliers used in the United Kingdom; equivalents elsewhere are fine, the specifications on the [dimensions](dimensions.md) page are what matter.
...
For an 4 arm maze, we need (with spares) 50 side panels and 50 makerbeam posts, celing and floor plates.
Also need M3 bolts.
