...
SECTION_HELP = {
    ...
    "detection": (
        ...
        "depends on your illumination. <b>Detection sensitivity</b> is where the "
        "line sits: too high and shadows trigger entries, too low and a small "
        "animal at the edge of an arm is missed.<br><br>"
        "Do not guess at either. Press <b>Check camera</b> for a live view with "
        "the arm boxes drawn on it and both values as sliders, so you can see the "
        "effect while you move them. Walk a hand down the maze and watch the boxes "
        "turn red. Press s in that window to bring the values you settle on back "
        "here.<br><br>"
